...
<div class="body"> 
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      <li class="parallax" style="background-image:url(images/banner1.jpg);" alt="Huacachina"></li>
      <li class="parallax" style="background-image:url(images/banner2.jpg);" alt="hoteles en ica"></li>
      <li class="parallax" style="background-image:url(images/banner3.jpg);" alt="hoteles en ica"></li>
    </ul>
  </div>
  <!-- End Hero Slider --> 
  ...
  <div class="introduccion">
      <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 introduccion-p">
                <p class="p-1">Bienvenidos al sitio web de los mejores servicios de hoteles más económicos en Ica.</p>
                <p class="p-2">Ica, valle de enigmas y buen pisco, de espectaculares dunas e inmenso desierto transformado en campos fértiles por culturas del pasado. Tierra de valles, sol, playas y Reservas Naturales pobladas de una generosa variedad de especies de flora y fauna. Pueblos de misterio, hogar del pisco, buen vino, música y un oasis como la Laguna de Huacachina, pedazo de vida en el corazón de un manto de arena.<br><strong> Ica, más de un motivo para disfrutarla.</strong></p> 
            </div>
            <div class="col-md-2">
            </div>
          </div>
 ...
 <div class="row">
  <div class="col-xs-6 col-md-3">
    <a href="#" class="thumbnail">
      <img src="images/pisco.jpg" alt="Día Nacional del Pisco Sour">
    </a>
    <div class="caption">
        <h3>Día del Pisco Sour</h3>
        <p>06 de Febrero.<br>El Pisco es la bebida emblema de Ica y por ello no puede ser ajena a la celebración del Día del Pisco Sour.</p>
        <p><a href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#pisco">Ver más</a></p>
      </div>
    </div>
    
   <div class="col-xs-6 col-md-3">
    <a href="#" class="thumbnail">
      <img src="images/vendimia.jpg" alt="Vendimia de Ica">
    </a>
    <div class="caption">
        <h3>Vendimia de Ica</h3>
        <p>Del 04 al 11 de Marzo.<br>La celebración de la Fiesta de la Vendimia, es la cosecha de la uva que unifica el arte y la cultura.</p>
        <p><a href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#vendimia">Ver más</a></p>
      </div>
    </div>
    
     <div class="col-xs-6 col-md-3">
    <a href="#" class="thumbnail">
      <img src="images/semanasanta.jpg" alt="Semana Santa en Ica">
    </a>
    <div class="caption">
        <h3>Semana Santa</h3>
        <p>Marzo - Abril.<br>La Festividad se inicia el Domingo de Ramos con la procesión del Señor del Triunfo.</p>
        <p><a href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#semanasanta">Ver más</a></p>
      </div>
    </div>
    
     <div class="col-xs-6 col-md-3">
    <a href="#" class="thumbnail">
      <img src="images/luren.jpg" alt="Fiesta del Señor de Luren">
    </a>
    <div class="caption">
        <h3>Señor de Luren.</h3>
        <p>Del 10 al 20 de Octubre<br>Se remonta a 1570 el origen de la devoción al Patrono de Ica Señor de Luren.</p>
        <p><a href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#luren">Ver más</a></p>
      </div>
    </div>
...
<br><br>
  <!--Fin de fechas de celebración-->
  <div class="main seccion-2" role="main">
    <div id="content" class="content full">
      <div class="container">
        <div class="row">
            ...
            <!-- Latest News -->
              <div class="listing post-listing">
                    <header class="listing-header">
                        <a href="http://hotelesenica.com.pe/blog/" target="_blank"><h3>Últimas Noticias</h3></a>
                    </header>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 noticias">
                        <div class="noticias-header">
                          <h2><a href="http://hotelesenica.com.pe/blog/?p=<?php echo $registros["ID"] ; ?>" target="_blank"><?php echo $registros["post_title"];  ?></a></h2>
                          <span class="meta-data"><i class="fa fa-calendar"></i><?php  echo $registros["post_date"]; ?></span></div>
                          <p class="noticias-contenido"><?php echo substr($registros['post_content'],0,870); ?></p>
                       <br>
                      </div>
                      <?php
                    }
              ...
              <div class="row">
                      <div class="col-md-12 link-blog">
                        <a href="http://hotelesenica.com.pe/blog/"><input type="submit" value="Ir a Blog" class="btn btn-primary"></a>
                      </div>
                    </div>
          </div>
          <!-- Start Sidebar -->
        ...
        <div class="row">
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing post-listing">
              ...
              <section class="listing-cont">
                  <p>Si deseas anunciar con nosotros el servicio de Hotel que brindas en la ciudad en Ica. No dudes en ponerte en contacto. Llena el siguiente formulario y un representante se comunicara contigo.<br>
                  No pierdas esta magnífica oportunidad tenemos planes muy económicos para anunciar.</p>
